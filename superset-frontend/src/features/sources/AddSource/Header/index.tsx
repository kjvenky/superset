...
export const DEFAULT_TITLE = t('New Source');
...
export default function Header({
  ...
  setSource: Dispatch<SourceReducerActionType>;
  ...
  const editableTitleProps = {
    ...
    onSave: (newSourceName: string) => {
      setSource({
        type: SourceActionType.ChangeSource,
        payload: { name: 'source_name', value: newSourceName },
      });
    },
    canEdit: false,
    label: t('source name'),
